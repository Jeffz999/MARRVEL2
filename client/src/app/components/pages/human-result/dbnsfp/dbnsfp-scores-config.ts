...
export const DBNSFP_SCORES_CONFIG: ScoreDisplayConfig[] = [
    ...
    },
    {
        ...
        toolTooltip:
            'unsupervised model incorporating structural context of an AlphaFold-derived system predicts the pathogenicity of human missense variants.',
        scoreTooltip:
            'Range: 0 to 1. The larger the score, the more likely the variant is pathogenic.',
        rankscoreKey: 'rankscore',
    },
    {
        ...
        scoreKey: 'prediction',
        toolTooltip:
            'Pathogenicity prediction for missense variants based on common variants of non-human primate species using a deep neural network.',
    ...
    },
    {
        ...
        version: '2021',
        toolTooltip:
            'MutationTaster prediction. The score cutoff between Disease Causing and Polymorphism is 0.5 for MTnew and 0.31733 for the rankscore.',
        scoreTooltip:
            'Possible scores are: Disease Causing Automatic, Disease Causing, Polymorphism, and Polymorphism Automatic',
    ...
    },
    {
        ...
        version: 'v1.3',
        toolTooltip:
            'Uses conservation data and trained on mutations linked to Mendelian diseases.',
        scoreTooltip: 'Possible scores are: Tolerated or Damaging',
        rankscoreKey: 'rankscore',
    },
    {
        ...
        version: 'v2.2.2',
        toolTooltip:
            'Uses eight sequence-based and three structure-based predictive features. Trained with Mendelian disease mutations and SNVs from close mammalian homolog proteins.',
    ...
    },
    {
        ...
        version: 'v2.2.2',
        toolTooltip:
            'Uses eight sequence-based and three structure-based predictive features. Trained with disease associated and common SNVs.',
        scoreTooltip: 'Possible scores are: Benign, Possibly Damaging, and Probably Damaging',
        rankscoreKey: 'rankscore',
    },
    {
    ...
    },
    {
        ...
        scoreKey: 'score',
        toolTooltip:
            'conservation score based on the multiple alignments of 470 mammalian genomes (including human).',
        scoreTooltip:
            'Scores range from -20 to 11.936. The larger the score, the more conserved the site.',
        rankscoreKey: 'rankscore',
    },
];
