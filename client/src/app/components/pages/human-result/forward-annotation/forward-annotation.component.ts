        ...
        this.apiService.getForwardAnnotByVariant(this.variant).subscribe(
            (res: TransVarForwardAnnotResult) => {
                ...
                if (Object.keys(trptsByAnnot).length) {
                    ...
                    this.candidates = Object.keys(trptsByAnnot)
                        .map((annot) => {
                            return {
                                annot: annot,
                        ...
                        .sort((a1, a2) => {
                            // One with a canonical transcript goes first. The others sorted by anotation
                            if (a1.transcripts[0].isCanonical !== a2.transcripts[0].isCanonical) {
                                return a1.transcripts[0].isCanonical > a2.transcripts[0].isCanonical
                                    ? -1
                                    : 1;
                            }
