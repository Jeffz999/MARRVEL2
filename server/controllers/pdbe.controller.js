...
const update = (doc) => {
	return new Promise((resolve, reject) => {
		PdbeSummaries.updateOne({ uniprotKBId: doc.uniprotKBId }, { ...doc, lastUpdate: new Date() }, { upsert: true })
			.then(() => {
				resolve(doc);
			})
			.catch((err) => {
